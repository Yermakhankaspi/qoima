 ...
 *   Упаковка               → ACCEPTED_BY_MERCHANT (приняли, надо собрать)
 *   Передача               → ASSEMBLE (собран, ждёт передачи курьеру)
 *   Переданы на доставку   → ARRIVED, KASPI_DELIVERY_* (в пути)
 *   Отменены при доставке  → CANCELLING
...
function kaspiSection(o, now) {
  ...
  if (st === 'ASSEMBLE') return 'transfer';
